...
class MsQuery(models.Model):
    ...
    backup = fields.Text('Backup Syntax', help="Backup your query if needed", required=0)
    name = fields.Text('Syntax', required=1)
    ...
    def execute_query(self):
        ...
        x = self.name+'<br><br>Executed on '+str(self.get_real_datetime())
        self.message_post()
